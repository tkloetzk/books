...
describe('google actions', () => {
  ...
  it('can throw error on get google book', () => {
    const store = createMockStore()
    const response = null
    const expectedResponse = [{"isLoading": "loading", "type": "FETCH_GOOGLE_BOOK_IS_LOADING"}, {"isLoading": "errored", "type": "FETCH_GOOGLE_BOOK_IS_LOADING"}, {"error": null, "hasErrored": true, "type": "FETCH_GOOGLE_BOOK_HAS_ERRORED"}]
